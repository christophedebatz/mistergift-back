 ...
 */
public class JpaEntityPersistenceService<E extends BaseEntity<ID>, ID extends Serializable> implements JpaEntityService<E, ID> {

    /** The logger. */
    private static final Logger LOGGER = LoggerFactory.getLogger(JpaEntityPersistenceService.class);

    /** The repository. */
    @Inject
    private JpaEntityRepository<E, ID> repository;
    ...
    public Iterable<E> save(Iterable<E> entities) {
        ...
        Iterable<E> savedEntities = repository.save(entities);
     ...
     */
    protected final JpaEntityRepository<E, ID> getRepository() {
        return repository;
    }
